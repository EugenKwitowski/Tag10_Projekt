fun main() {
    ...
    var fahrzeugeZuGeschwindigkeit: MutableMap<String, Double> = mutableMapOf(
        "Auto" to 120.5,
        "Flugzeug" to 755.2,
        "Fahrrad" to 22.0,
        "Tretroller" to 15.7
    )
    println(fahrzeugeZuGeschwindigkeit)

    var alleSchlüßel = fahrzeugeZuGeschwindigkeit.keys.toMutableList()
    println(alleSchlüßel)
}